...
public class TexasHoldem extends Poker implements Serializable
{
	...
	public String toString() {
		return "TexasHoldem [" + (tableCards != null ? "tableCards=" + tableCards + ", " : "") + "pot=" + pot
				+ ", smallBlind=" + smallBlind + ", bigBlind=" + bigBlind + ", enterCashAmt=" + enterCashAmt + ", "
				+ (players != null ? "players=" + players + ", " : "")
				+ (gameDeck != null ? "gameDeck=" + gameDeck + ", " : "") + "numPlayers=" + numPlayers + "]";
	}
